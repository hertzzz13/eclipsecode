...
public class ClosureOrderEntity {
	...
	public ClosureOrderEntity(int co_id, int control_no, int bldgpermit_no, String applicants_name, String project_name,
			String address, String type_occupancy, String contact_no, String administrative_fine, String status) {
		super();
		this.co_id = co_id;
